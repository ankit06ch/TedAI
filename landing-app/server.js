...
app.post('/api/generate-adhd-insights', async (req, res) => {
  try {
    ...
    // Predefined lists of insights (3-4 words each)
    ...
    const attentionPatterns = [
      ...
      'Switches topics',
      'Hyperfocuses on preferences',
      'Needs redirection',
      'Visual engagement better'
    ]
    ...
    const insights = {
      behavioralObservations: selectRandom(behavioralObservations),
      attentionPatterns: selectRandom(attentionPatterns),
      recommendations: selectRandom(recommendations)
    }
